...
export const TRAINING_LEVELS: TrainingLevel[] = [
  ...
  { id: 7, name: '霓虹竞技场', description: '多层平台间跳跃收集 10 个光球，霓虹灯风格', scene_type: 'training_arena', default_duration_seconds: 480, max_duration_seconds: 600, movement_speed: 2.2, turn_speed: 70, fov: 85, head_bob_strength: 0, visual_complexity: 4, vertical_motion: true },
  { id: 8, name: 'FPS 静态靶场', description: '站在射击位瞄准点击弹出的人形靶子，25个目标', scene_type: 'fps_range', default_duration_seconds: 360, max_duration_seconds: 480, movement_speed: 0, turn_speed: 80, fov: 90, head_bob_strength: 0, visual_complexity: 4, vertical_motion: false },
  { id: 9, name: 'FPS 移动靶', description: '靶子移动+左右平移+90°转身瞄准，25个目标', scene_type: 'fps_range', default_duration_seconds: 420, max_duration_seconds: 540, movement_speed: 2.0, turn_speed: 100, fov: 90, head_bob_strength: 0, visual_complexity: 4, vertical_motion: false },
  { id: 10, name: '开放世界探索', description: '户外草地土路，穿过树林走到石塔登顶，5 个路标', scene_type: 'open_world_mini', default_duration_seconds: 480, max_duration_seconds: 720, movement_speed: 2.5, turn_speed: 80, fov: 90, head_bob_strength: 0, visual_complexity: 4, vertical_motion: false },
  { id: 11, name: '慢跑 + 镜头晃动', description: '同样的户外路线但跑步速度 + head bob 模拟真实跑步', scene_type: 'open_world_mini', default_duration_seconds: 420, max_duration_seconds: 600, movement_speed: 3.5, turn_speed: 90, fov: 95, head_bob_strength: 12, visual_complexity: 5, vertical_motion: false },
  { id: 12, name: '高级综合挑战', description: '高强度综合训练：开放世界跑步+镜头晃动+转向', scene_type: 'open_world_mini', default_duration_seconds: 600, max_duration_seconds: 900, movement_speed: 4.0, turn_speed: 100, fov: 100, head_bob_strength: 20, visual_complexity: 5, vertical_motion: true },
];
